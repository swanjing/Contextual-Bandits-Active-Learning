...
class QueryStrategy(with_metaclass(ABCMeta, object)):
    ...
    def __init__(self, dataset, args, **kwargs):
        ...
        self._loader_te_args = args['loader_te_args']
        self._args = args
        use_cuda = torch.cuda.is_available()
        self.device = torch.device("cuda" if use_cuda else "cpu")
        self._handler = args['handler']
        self._nclasses = args['nclasses']
    ...
    @property
    def handler(self):
        """The torch DataLoader object that is associated with this QueryStrategy."""
    ...
    @property
    def loader_te_args(self):
        """The torch DataLoader object that is associated with this QueryStrategy."""
        return self._loader_te_args
